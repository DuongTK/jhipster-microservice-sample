...
import com.jmango360.test.config.KafkaProperties;
...
class JhipsterMicroserviceSampleKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterMicroserviceSampleKafkaResource kafkaResource = new JhipsterMicroserviceSampleKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-microservice-sample-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-microservice-sample-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
