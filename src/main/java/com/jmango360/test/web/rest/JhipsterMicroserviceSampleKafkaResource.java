...
@RestController
@RequestMapping("/api/jhipster-microservice-sample-kafka")
public class JhipsterMicroserviceSampleKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JhipsterMicroserviceSampleKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterMicroserviceSampleKafkaResource(KafkaProperties kafkaProperties) {
